// 标注有 '增加tilesUrl' 部分均为自己定义 tilesUrl变量，值为网站根目录，例如 192.168.1.170/czmap/       该目录下包含images,js,maptile三个文件夹
// var tilesUrl='http://lby.tunnel.2bdata.com/baidu_map/';
// var tilesUrl='http://147.1.4.90/cz_map_data/';
var tilesUrl='http://192.168.1.199:8080/baidu_map/';
...
(function() {
    ...
    var cc = {
        imgPath: tilesUrl + "images/", //******* �Ķ�ͼƬimages·�� *******  //增加tilesUrl    
        cityNames: {
            "\u5317\u4eac": "bj",
            "\u4e0a\u6d77": "sh",
            "\u6df1\u5733": "sz",
    ...
    a8.object.extend(cA, {
        ...
        preLoaded: {},
        Config: {
            _baseUrl: tilesUrl + "js/", //x + "getmodules?v=1.3",     //增加tilesUrl                     //******* �Ķ���Դ��map,oppc,tile,control��·�� *******
            _timeout: 5000
        },
        delayFlag: false,
        Module: {
        ...
        .extend(
            n.prototype, {
                ...
                draw: function() {
                    ...
                    this._config.offset = new aH(-Math.round(this._config.width / 2) -
                        Math
                        .round(this._config.lineStroke), -Math.round(this._config.height / 2) -
                        Math
    ...
    aT.getTilesUrl = function(cM, cP) {
        ...
        //		}
        cL = tilesUrl + "maptile/" + cP + "/" + cQ + "/" + cN + ".jpg"; //增加tilesUrl    
